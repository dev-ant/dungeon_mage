...
```
data/spells.json          ← spell stat data
data/rooms.json           ← room/floor data
scripts/player/player.gd  ← player logic
scripts/autoload/game_state.gd  ← skill levels, save data
scenes/                   ← mirrors scripts/ structure
tests/                    ← one test file per system
```
