...
이 문서는 액티브, 버프, 설치, 온앤오프, 패시브 마스터리 스킬을 실제 데이터 파일로 옮길 때 사용하는 기준 스키마 문서입니다. Claude가 이후 `skills.json` 같은 게임 데이터 파일을 만들 때 이 문서를 우선 기준으로 삼습니다.
...
| 문서 이름 | 권장 skill_id |
| --- | --- |
| Ember Dart | `fire_ember_dart` |
| Aqua Bullet | `water_aqua_bullet` |
| Mana Veil | `holy_mana_veil` |
| Grave Pact | `dark_grave_pact` |
...
```json
{
  ...
  "milestone_bonuses": [
    { "level": 8, "stat": "explosion_radius", "value": 12 },
    { "level": 16, "stat": "explosion_radius", "value": 12 },
    { "level": 24, "stat": "explosion_radius", "value": 12 }
  ]
}
```
...
- 실제 계산식은 [skill_level_rules.md](/Users/leesanghyun/git-projects/java-projects/old/dungeon_mage/docs/progression/skill_level_rules.md)를 우선합니다.
- 서클 판정은 [circle_progression.md](/Users/leesanghyun/git-projects/java-projects/old/dungeon_mage/docs/progression/circle_progression.md)를 따릅니다.
- 버프 조합은 [buff_combo_catalog.md](/Users/leesanghyun/git-projects/java-projects/old/dungeon_mage/docs/progression/buff_combo_catalog.md)의 `required_buffs`와 연결합니다.
