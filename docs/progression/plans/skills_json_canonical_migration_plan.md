...
- `skills.json / spells.json` 최소 validation source of truth는 2026-04-03 구조 개선 후속 증분부터 `/Users/leesanghyun/git-projects/java-projects/old/dungeon_mage/scripts/autoload/game_database.gd`의 `validate_skill_entry()`, `validate_spell_entry()`, `validate_skill_spell_link()`, `validate_spell_skill_link()`다.
