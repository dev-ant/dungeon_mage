...
이 문서는 [전투 우선 구현 계획](/Users/leesanghyun/git-projects/java-projects/old/dungeon_mage/docs/implementation/combat_first_build_plan.md)의 첫 번째 증분인 `플레이어 컨트롤러 고정`을 Claude가 바로 구현할 수 있도록 쪼갠 작업 체크리스트다.
